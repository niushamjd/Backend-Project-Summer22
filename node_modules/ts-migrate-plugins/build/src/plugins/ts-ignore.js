...
const tsIgnorePlugin = {
    ...
    validate: (0, validateOptions_1.createValidate)(optionProperties),
};
...
function getTextWithIgnores(sourceFile, diagnostics, options) {
    ...
    diagnostics.forEach((diagnostic) => {
        ...
        const messageLimit = (_a = options.messageLimit) !== null && _a !== void 0 ? _a : TS_IGNORE_MESSAGE_LIMIT;
        const tsIgnoreCommentText = `@${errorExpression} ts-migrate(${code}) FIXME: ${message.length > messageLimit
    ...
    return (0, updateSourceText_1.default)(text, updates);
}
